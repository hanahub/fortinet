<table cellpadding="0" cellspacing="0" border="0" class="display groceryCrudTable" id="<?php echo uniqid(); ?>">
	...
	<tbody>
		...
		<tr id='row-<?php echo $num_row?>'>
			...
			<td class='actions'>
				...
				?>
						<a href="<?php echo $action_url; ?>" class="btn btn-primary btn-xs edit_button" role="button">
				...
				?>
				<?php if(!$unset_read){?>
					<a href="<?php echo $row->read_url?>" class="btn btn-primary btn-xs edit_button" role="button">
				...
				<?php if(!$unset_edit){?>
					<a href="<?php echo $row->edit_url?>" class="btn btn-primary btn-xs edit_button" role="button">
				...
				<?php if(!$unset_delete){?>
					<a onclick = "javascript: return delete_row('<?php echo $row->delete_url?>', '<?php echo $num_row?>')"
						href="javascript:void(0)" class="btn btn-danger btn-xs delete_button" role="button">
	...
	<tfoot>
		<tr>
			...
			<?php if(!$unset_delete || !$unset_edit || !$unset_read || !empty($actions)){?>
				<th>
					<button class="btn btn-primary btn-xs floatR refresh-data" role="button" data-url="<?php echo $ajax_list_url; ?>">
						<span class="ui-button-icon-primary ui-icon ui-icon-refresh"></span><span class="ui-button-text">&nbsp;</span>
					</button>
					<a href="javascript:void(0)" role="button" class="btn btn-primary btn-xs clear-filtering floatR">
